...
export default class CommentReplyList extends Component {
    ...
    getReplyList = async () => {
        ...
        let commentId = this.state.articleCommentId;
        let url = baseUrl+'/app/column/getReplyList?commentId=' + commentId + '&pageNum=' + page + '&pageSize=' + limit;
    ...
    toReply=async ()=>{
        ...
        let commentId = item.articleCommentId;
